...
class FirestoreService {
  ...
  Future<ApplicationUser> fetchUser(String userId) {
    return _db
        ...
        .doc(userId)
        .get()
        .then((snapshot) => ApplicationUser.fromFirestore(snapshot?.data() as Map<String,dynamic>));
  }
  ...
  Future<Product> fetchProduct(String productId){
    ...
    .get().then((snapshot) => Product.fromFirestore(snapshot?.data() as Map<String,dynamic>));
  }
  ...
  Future<Vendor> fetchVendor(String vendorId){
    return _db
      .collection('vendors')
      .doc(vendorId)
      .get().then((snapshot) => Vendor.fromFirestore(snapshot?.data() as Map<String,dynamic>));
  }
