...
abstract class Routes {
  static MaterialPageRoute materialRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case "/editproduct":
        return MaterialPageRoute(builder: (context) => EditProduct(productId: 'kovid',));
      case "/editvendor":
        return MaterialPageRoute(builder: (context) => EditVendor(vendorId: 'Kovid',));
      default:
  ...
  static CupertinoPageRoute cupertinoRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case "/editproduct":
        return CupertinoPageRoute(builder: (context) => EditProduct(productId: 'kovid',));
       case "/editvendor":
        return CupertinoPageRoute(builder: (context) => EditVendor(vendorId: 'Kovid',));
      default:
        var routeArray = settings.name?.split('/');
        if (settings.name!.contains('/editproduct/')) {
