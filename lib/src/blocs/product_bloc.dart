   ...
   // var permissionStatus = await Permission.photos.status;
    //if (permissionStatus.isGranted) {
      ...
      if (image != null) {
        ...
        //CropImage
        if (properties.height! > properties.width!.toInt()){
          var yoffset = (properties.height! - properties.width!.toInt())/2;
          croppedFile = await FlutterNativeImage.cropImage(image.path, 0, yoffset.toInt(), properties.width!.toInt(), properties.width!.toInt());
        } else if (properties.width! > properties.height!.toInt()) {
          var xoffset = (properties.width!- properties.height!.toInt())/2;
          croppedFile = await FlutterNativeImage.cropImage(image.path, xoffset.toInt(), 0, properties.height!.toInt(), properties.height!.toInt());
        } else {
